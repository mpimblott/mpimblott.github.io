...
function App() {
  return (
    <div className="h-screen w-screen">
      <div className="snap-start bg-gray-900 h-screen w-screen flex flex-col items-center justify-center text-white">
        <h1 className="text-6xl font-bold mb-4">Matthew Pimblott</h1>
