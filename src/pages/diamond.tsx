...
const projects: Project[] = [{
  ...
  description: "I designed and developed a web user interface for the semantic segmentation tool, bringing the" +
    " project from inception to deployment company-wide. I used VueJs to build the interface and FastAPI to build" +
    " the backed integrating with the existing segmentation tools in development within the department. This" +
  ...
  description: "I worked on a research project to develop a novel pre-training technique for deep learning models," +
    " building upon existing research to enhance performance in the context of" +
    " X-ray tomography. This domain presents challenges due very large, low-contrast, high noise datasets. " +
    " Due to the huge number of research areas covered at Diamond the content being studied also varies greatly" +
    " from application to application. This means relevant training data is often sparse and the cost of operating" +
